...
In our simulation study, samples are generated from the model described in Assumption~\ref{theModel},   
...
Table~\ref{biaoge1}, respectively.
...
In all case, the empirical level tends to be more close to $0.05$ as $n$ increases.
...
Next, we simulate the empirical power of our test.
